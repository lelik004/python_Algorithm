...
Первый вариант.
Сумма места, занимаемого переменными: 12348
Сразу бросается в глаза, что deque занимает много места.
Немного сократить место можно используя кортежи вместо списков.
